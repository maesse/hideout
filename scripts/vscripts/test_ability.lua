...
function test_ability:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end
 
--------------------------------------------------------------------------------
 
function test_ability:CastFilterResultTarget( hTarget )
  print("CastFilterResultTarget")
...
function test_ability:GetCustomCastErrorTarget( hTarget )
	if self:GetCaster() == hTarget then
...
function test_ability:GetCooldown( nLevel )
